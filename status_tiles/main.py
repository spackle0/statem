...
def main():
    ...
    parser.add_argument("--config", type=Path, default="config.yml", help="Path to config file")
    ...
    uvicorn.run(
        "status_tiles.api:app", host=args.host, port=args.port, reload=args.reload, log_level=config.log.level.lower()
    )
